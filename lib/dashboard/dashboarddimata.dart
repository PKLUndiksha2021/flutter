...
class DashboardDimata extends StatefulWidget {
  const DashboardDimata({
    Key key,
  }) : super(key: key);
  @override
  _DashboardDimataState createState() => _DashboardDimataState();
}

class _DashboardDimataState extends State<DashboardDimata> {
